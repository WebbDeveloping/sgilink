...
export function ValuePropositionsCards() {
  const cards: StickyParallaxCard[] = [
    {
      id: "systems",
      content: (
        <div className="relative isolate overflow-hidden bg-brand-dark rounded-2xl sm:rounded-3xl px-4 pt-12 shadow-2xl sm:px-6 sm:pt-16 md:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-4 text-base/7 text-pretty text-white/90 sm:mt-6 sm:text-lg/8">
              SGI-LINK deploys capital exclusively into SGI&apos;s own algorithmic
              trading systems—developed, tested, and refined in-house. These
              systems combine advanced quantitative technology with robust
              risk-management frameworks designed to perform across diverse FX and
              commodities markets.
            </p>
      ...
      content: (
        <div className="relative isolate overflow-hidden bg-brand-dark rounded-2xl sm:rounded-3xl px-4 pt-12 shadow-2xl sm:px-6 sm:pt-16 md:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-4 text-base/7 text-pretty text-white/90 sm:mt-6 sm:text-lg/8">
              Our systems weren&apos;t built on backtests alone. SGI was developed
              through years of live trading across FX and commodities markets.
              Many ideas were discarded. The systems that remain reflect what
              survived real liquidity shocks, changing regimes, and actual market
              conditions.
            </p>
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:mt-10 sm:flex-row sm:gap-x-6 lg:justify-start">
              <a
        ...
        <div className="relative isolate overflow-hidden bg-brand-dark rounded-2xl sm:rounded-3xl px-4 pt-12 shadow-2xl sm:px-6 sm:pt-16 md:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-4 text-base/7 text-pretty text-white/90 sm:mt-6 sm:text-lg/8">
              ...
              technology-powered returns without day-to-day decisions. A
              fully automated, hands-off portfolio that runs consistently
  ...
  return (
    <section className="relative z-30 bg-surface py-12 sm:py-16 lg:py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 sm:mb-16">
          <ScrollReveal>
            <SectionTitle as="h2" className="text-center text-2xl font-bold sm:text-3xl lg:text-4xl xl:text-5xl">

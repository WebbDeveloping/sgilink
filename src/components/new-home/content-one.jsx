          ...
          <div>
            <div className="text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-6">
                  SGI Link is a cloud-based software platform that facilitates
                  the administration of trading f unds in foreign exchange (FX),
                  commodities, and digital assets. It serves two primary user
                  groups:
                </p>
                <p className="mt-8">
                  <strong>Fund Managers and Algorithmic Traders:</strong>{" "}
                  Professionals who create and manage trading strategies,
                  leveraging SGI Link to onboard investors, automate operations,
                  and deliver performance reports.
                  <br />
                  <strong>Investors:</strong> Accredited individuals or
                  institutions who invest capital in SGI Link-managed f unds,
                  accessing real-time data and maintaining control over their f
                  unds.
                </p>
                <p className="mt-8">
                  SGI Link is not a financial institution, broker, or custodian.
                  It is a software provider that integrates with third-party
                  Broker Access Partners (BAPs) and regulated brokerages to
                  execute trades and hold investor f unds. This non-custodial
                  model ensures SGI Link does not hold or manage client assets,
                  enhancing investor safety and reducing fiduciary risks for
                  Fund Managers.
                </p>
              </div>
            </div>

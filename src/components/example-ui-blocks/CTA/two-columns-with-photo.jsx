      ...
      <div className="relative isolate">
          ...
          <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-surface/75 px-6 py-16 shadow-lg ring-1 ring-gray-900/5 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
            ...
            <div className="w-full flex-auto">
              ...
              <div className="mt-10 flex">
                <a
                  href="#"
                  className="text-sm/6 font-semibold text-brand hover:text-indigo-300"
                >
        ...
        >
          <div
            ...
            className="aspect-1318/752 w-329.5 flex-none bg-linear-to-r from-brand-soft to-brand opacity-50"
          />
        </div>
      </div>
    </div>
